...
public class OrderReceiveController {
    ...
    public String getAllOrders(Model model) {
        SuccessEvaluator<OrderSupplierHeader> getClosedOrdersSuccess = orderSupplierHeaderService.getAllClosedOrders();
        if (!getClosedOrdersSuccess.getIsSuccessfull()) {
            model.addAttribute("error", getClosedOrdersSuccess.getMessage());
        }
        List<OrderSupplierHeader> orderSupplierHeaderList = getClosedOrdersSuccess.getEntities();
    ...
    public String viewOrder(@PathVariable("orderId") Long orderId, Model model) {
        SuccessEvaluator<OrderSupplierHeader> findOrderSuccess = orderSupplierHeaderService.findById(orderId);
